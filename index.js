...
/*
  Добавить статусы для задач

  добавляем поле status, у которого будет 3 значения (created, inProgress, done)
  когда создаем задачу по умолчанию она создается со статусом created
  в блок с кнопками редактировать и удалить добавляем еще 3 кнопки (Создана, В работу, Готово), которые будут переводить задачу в соответствующий статус
  когда задача создана, кнопка Создана должна находиться в состоянии disabled
  иконки для новых кнопок взять здесь https://www.flaticon.com/

  добавляем вкладки, которые будут фильтровать задачи по статусам. по умолчанию активная вкладка Созданы
*/
